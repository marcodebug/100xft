...
const platforms = [
  { id: 'mt5', name: 'MetaTrader 5', logo: '/logos/logo5.svg' },
  { id: 'ctrader', name: 'cTrader', logo: '/logos/logo8.svg' },
      ...
      <div className="mt-12 grid gap-6">
        ...
        <div className="bg-black/30 border border-white/10 rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-3">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/logos/logo5.svg" alt="MetaTrader 5" className="h-6 w-6" />
        ...
        <div className="bg-black/30 border border-white/10 rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-3">
            <img src="/logos/logo8.svg" alt="cTrader" className="h-6 w-6" />
